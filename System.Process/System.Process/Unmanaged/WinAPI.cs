...
namespace System.Process.Unmanaged
{
    public class WinAPI
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, byte[] lpBuffer, int dwSize, out byte[] lpNumberOfBytesRead);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool WriteProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, byte[] lpBuffer, Int32 nSizeout, ref long _wrote);
   ...
   IntPtr dwSize, AllocationType flAllocationType, MemoryProtection flProtect);
        ...
        #region User32
        public delegate void hProcedure(int code, IntPtr wParam, IntPtr lParam);


        [DllImport("user32.dll", SetLastError = true)]
        public static extern IntPtr SetWindowsHookEx(HookType hookType, IntPtr DLL, IntPtr hMod, uint dwThreadId);

        [DllImport("user32.dll", SetLastError = true)]
        public static extern IntPtr SetWindowsHookEx(HookType hookType, hProcedure Function, IntPtr hMod, uint dwThreadId);
